...
server: hw_server.o hw_svc.o hw_xdr.o rdma_queue2.o read_dev.o example64.o sha_funcs.o
	cc -O3 -Wall -mtune=cortex-a57 -mcpu=cortex-a57+crypto -L/usr/lib -libverbs -lpthread -o server example64.o hw_server.o hw_svc.o hw_xdr.o rdma_queue2.o  read_dev.o armv8_hash_asm.S  sha_funcs.o -lnsl -L. libz.a
